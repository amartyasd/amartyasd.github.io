...
|  | Title | Authors | 
|------|-------|---------|
|  | Twisted Geometric Satake Equivalence |MICHAEL FINKELBERG AND SERGEY LYSENKO|
|  | PARAMETERS AND DUALITY FOR THE METAPLECTIC GEOMETRIC LANGLANDS THEORY| D. GAITSGORY AND S. LYSENKO | 


## Participation

For access to the Zoom meetings and Discord server, please contact the seminar organisers.
