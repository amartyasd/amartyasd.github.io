...
The idea is to prove the correspondence between adding a norm map to the $N_{\infty}$-operad and a clockwise rotation operation to a tree. Here's a pictorial description of the equivalence
